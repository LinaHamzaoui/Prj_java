...
public class SupprimerLocation extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SupprimerLocation frame = new SupprimerLocation();
	...
	public SupprimerLocation() {
		...
		this.setTitle("Supprimer Location");;
		...
		label = new JLabel();
		label.setText("Veuillez remplir les champs suivants pour supprimer une location:");
		...
		valider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					String req = "DELETE FROM 'location' WHERE 'nom' ="+ nom+"AND 'prenom'="+prenom+"";
		...
		retour.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dispose();
				InterfaceLocation a=new InterfaceLocation();
				a.setVisible(true);
